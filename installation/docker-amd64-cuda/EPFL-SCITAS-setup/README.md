...
enroot import docker://registry.rcp.epfl.ch#claire/moalla/mup:amd64-cuda-root-latest
...
apptainer pull docker://registry.rcp.epfl.ch/claire/moalla/mup:amd64-cuda-root-latest
```
...
git pull
cd mup/dev/installation/docker-amd64-cuda
```
...
3. Then follow the instructions [here](https://www.jetbrains.com/help/pycharm/remote-development-a.html#gateway) and
   ...
   something like `/scratch/moalla/mup/dev`).
